 ...
 * 
 */
public class CompositeKeyPrimaryDescSecondaryDescSortComparator extends WritableComparator {

	/* Constructor */
	protected CompositeKeyPrimaryDescSecondaryDescSortComparator() {
	...
	public int compare(WritableComparable w1, WritableComparable w2) {
		...
		// compare primary key
		int result = (-1) * key1.getPrimaryKey().compareTo(key2.getPrimaryKey());
